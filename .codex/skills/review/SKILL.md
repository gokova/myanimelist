---
name: review
description: Review a specified Git commit in an Android project for architecture, correctness, reliability, security, and UI issues.
---
...
3. Read and apply the repository's `AGENTS.md`, `DESIGN.md`, and `README.md` when relevant.
